...
import { ConfirmationType, PopUpType } from "@fusion/models/enums/component-type";
...
export class ConfirmationService {
  ...
  notify(header: string, message: string, type: PopUpType, key: ConfirmationType, event?: Event): void {
    this.confirmationService.confirm({
      target: event?.target as EventTarget,
      header: header,
      message: message,
